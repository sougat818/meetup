...
public class MeetupGroupResource {
    ...
    @Timed
    public ResponseEntity<List<MeetupGroup>> getAllMeetupGroups(@ApiParam Pageable pageable)
        throws URISyntaxException {
        log.debug("REST request to get a page of MeetupGroups");
        Page<MeetupGroup> page = meetupGroupService.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/meetup-groups");
